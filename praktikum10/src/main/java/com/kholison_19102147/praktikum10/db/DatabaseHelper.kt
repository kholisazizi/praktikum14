...
import com.kholison_19102147.praktikum10.db.DatabaseContract.QuoteColumns.Companion.TABLE_QUOTE
...
internal class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    companion object {
        ...
        private const val SQL_CREATE_TABLE_QUOTE = "CREATE TABLE $TABLE_QUOTE" +
                ...
                " ${DatabaseContract.QuoteColumns.WRITER} TEXT NOT NULL," +
                " ${DatabaseContract.QuoteColumns.PLACE} TEXT NOT NULL)"
    }
