package com.kholison_19102147.praktikum11.adapter
...
import com.kholison_19102147.praktikum11.QuoteAddUpdateActivity
import com.kholison_19102147.praktikum11.R
import com.kholison_19102147.praktikum11.data.Quote
import com.kholison_19102147.praktikum11.databinding.ItemQuoteBinding
...
import com.kholison_19102147.praktikum11.helper.REQUEST_UPDATE
...
class QuoteAdapter(private val activity: Activity): RecyclerView.Adapter<QuoteAdapter.QuoteViewHolder>() {
    ...
    inner class QuoteViewHolder(itemView: android.view.View) : RecyclerView.ViewHolder(itemView) {
